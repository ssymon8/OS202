...
public:
    ...
    std::vector<std::size_t> get_coords(std::unordered_map<std::size_t, std::uint8_t> m_fire_front);
    std::vector<std::uint8_t> get_powers(std::unordered_map<std::size_t, std::uint8_t> m_fire_front);
